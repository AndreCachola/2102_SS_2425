...
public class AddServicesFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfServiceName.setFont(new java.awt.Font("Montserrat", 1, 18)); // NOI18N

        tfPrice.setFont(new java.awt.Font("Montserrat", 1, 18)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double price;  // Change price to double
        ...
        try {
            ...
            if ("".equals(tfServiceName.getText())) {
                ...
                try {
                    price = Double.parseDouble(tfPrice.getText()); // Parse price as a double
                ...
                pst.setDouble(2, price);  // Use setDouble for the price
    ...
    public static void main(String args[]) {
        ...
        AddServicesFrame adds = new AddServicesFrame();
